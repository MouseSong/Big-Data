 ...
 * */
public class AvgSalaryAndEmpNumsOfDept extends Configured implements Tool{
	...
	private static class ReduceClass extends Reducer<Text, Text, Text, Text>{
		...
		protected void reduce(Text key, Iterable<Text> values, 
		    ...
		    context.write(key, new Text("AvgSalary:" + String.valueOf(sumSalary / empNums) + ", EmpNums:" + String.valueOf(empNums)));
		}
	}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(AvgSalaryAndEmpNumsOfDept.class);
	...
	public static void main(String[] args) throws Exception{
        ...
        "hdfs://node1:9000/inaction/home_task1/out/2"};
		Configuration config = new Configuration();
		config.addResource("hadoop-config.xml");
		int result = ToolRunner.run(config, new AvgSalaryAndEmpNumsOfDept(), params);
		System.exit(result);
	}
